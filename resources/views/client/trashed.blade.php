                                                ...
                                                <td>
                                                    <div class="dropdown show">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            <a class="dropdown-item" href="{{route("client.back.from.trash", $item->id)}}"><i style="color: #ffc107" class="far fa-eye "></i>&nbsp;إعادة تخزين</a>
                                                            <a class="dropdown-item" href="{{route("clients.delete_from.database", $item->id)}}"><i style="color: red" class="far fa-trash "></i>&nbsp;الحذف نهائياً</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
